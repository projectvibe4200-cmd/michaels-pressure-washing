...
<nav className="hidden gap-8 text-sm font-semibold text-zinc-900 md:flex">            <Link href="/services" className="hover:text-zinc-500">
              Services
            </Link>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid items-stretch gap-8 md:grid-cols-3">
              ...
              <article className="flex h-full flex-col rounded-3xl border border-zinc-200 p-8 transition hover:-translate-y-1 hover:shadow-lg">
                ...
                <h2 className="mt-6 text-2xl font-bold">Driveway Cleaning</h2>

                <p className="mt-4 leading-7 text-zinc-600">
                  Give your driveway a cleaner, refreshed appearance by removing
                  built-up dirt, grime, and surface stains.
                </p>
              ...
              <article className="flex h-full flex-col rounded-3xl border border-zinc-200 p-8 transition hover:-translate-y-1 hover:shadow-lg">
                ...
                <h2 className="mt-6 text-2xl font-bold">House Washing</h2>
        ...
        <section className="bg-zinc-100 px-6 py-24 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-zinc-600">
              Get in touch with Michael&apos;s Pressure Washing today for a free,
              no-obligation quote.
            </p>
