        ...
        <section className="bg-zinc-950 px-6 py-24 text-white">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              Ready to get your home looking its best? Contact us today for a
          ...
          <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-2 md:items-start">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-zinc-600">
                Have questions about pressure washing or ready to request a
                quote? Get in touch with Michael&apos;s Pressure Washing today.
              </p>
            </div>
        ...
        <section className="bg-zinc-950 px-6 py-24 text-white">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-zinc-300">
              Tell us a little about your project and Michael&apos;s Pressure
              Washing will get back to you.
            </p>
